...
import { RiMenu2Fill, RiSearchLine, RiSettings4Line, RiDashboardLine, RiShieldUserLine, RiLogoutBoxRLine } from "react-icons/ri";
            ...
            <nav className='w-full fixed top-0 left-0 z-[9999] right-0 text-black py-2 bg-white shadow-lg'>
                <div className='w-11/11 lg:w-10/12 mx-auto flex justify-between items-center'>
                    ...
                    <div className='hidden smd:flex xl:gap-x-6 xmd:gap-x-4 items-center gap-x-2 flex'>
                        ...
                        {user ? (
                            <div className="relative">
                                ...
                                >
                                    <img
                                        src={user.profileImage || 'https://attic.sh/8lfum8f9b0qplpe5jtj7m1kdcrrn'}
                                        alt="Profile"
                    ...
                    ${isOpen ? "translate-x-[0%]" : "translate-x-[100%]"} transition-all duration-500`}>
                        {user ? (
                            <div className="relative align-start w-full left-12 flex flex-col gap-y-2">
                                <button
                                    onClick={() => setShowProfileMenu(!showProfileMenu)}
                                    className="flex items-center space-x-2"
                                >
                ...
                {showSearch && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="absolute top-0 left-0 w-full h-screen bg-black/50 text-left fixed z-50"
                    >
